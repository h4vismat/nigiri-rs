...
### Reconcile the install snippets with the release versions

**Completed:** v0.6.0

Installation examples and the workspace version table now name the coordinated release versions.
Removed the obsolete claim that only facade 0.2.0 was published and documented the separate
`lightning-fixtures` feature consistently.
